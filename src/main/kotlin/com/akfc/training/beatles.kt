...
fun main() {
    ...
    File("src/main/resources/beatles_albums.xml").writeText(response.body())

    // Apply XSLT transformation
    val transformerFactory = TransformerFactory.newInstance()
    val xsltSource = StreamSource(File("src/main/resources/beatles_albums.xslt"))
    val transformer = transformerFactory.newTransformer(xsltSource)
    val xmlSource = StreamSource(File("src/main/resources/beatles_albums.xml"))
